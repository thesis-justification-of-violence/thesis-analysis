...
options(knitr.kable.NA = '') # NA en kable = ''
  ...
  #   labs(caption =
  #          paste0("Fuente: Authors calculations based on PACES Study"," (n=",dim(na.omit(procjv_analysis_nona))[1],")"))
...
df_notas<- rbind(b,a)
  ...
  scale_x_continuous(name = "Distribución Indices de Ideología",
                     breaks= 0:20,

...
plot_pred_jvest_1 <- plot_model(jv_est_2019.modelmulpub1, type = "pred", terms = c("sj_ceo_rec[all]"), title = "")  + geom_line() + theme(legend.position="bottom") + ylab("Probabilidad Predicha")
...
plot_pred_jvest_2 <- plot_model(jv_est_2019.modelmulpub2, type = "pred", terms = c("sj_ceo_rec[all]"), title = "")  + geom_line() + theme(legend.position="bottom") + ylab("Probabilidad Predicha")
...
plot_pred_jvest_3 <- plot_model(jv_est_2019.modelmulpub3, type = "pred", terms = c("sj_ceo_rec[all]"), title = "")  + geom_line() + theme(legend.position="bottom") + ylab("Probabilidad Predicha")
...
plot_pred_carab1_1 <- plot_model(jv_carab1_2019.modelmulpub1, type = "pred", terms = c("sj_obrero_rec[all]"), title = "")  + geom_line() + theme(legend.position="bottom") + ylab("Probabilidad Predicha")
...
plot_pred_carab2_1 <- plot_model(jv_carab2_2019.modelmulpub1, type = "pred", terms = c("sj_obrero_rec[all]"), title = "")  + geom_line() + theme(legend.position="bottom") + ylab("Probabilidad Predicha")
...
plot_pred_carab2_2 <- plot_model(jv_carab2_2019.modelmulpub2, type = "pred", terms = c("sj_obrero_rec[all]"), title = "")  + geom_line() + theme(legend.position="bottom") + ylab("Probabilidad Predicha")
...
plot_pred_carab2_3 <- plot_model(jv_carab2_2019.modelmulpub3, type = "pred", terms = c("sj_obrero_rec[all]"), title = "")  + geom_line() + theme(legend.position="bottom") + ylab("Probabilidad Predicha")

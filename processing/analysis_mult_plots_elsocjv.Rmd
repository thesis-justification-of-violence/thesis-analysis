...
plot_it2<- plot_model(jv_est_2019.modelmulpub5, type = "pred", terms = c("ingreso_satisfact_factor", "sj_ceo"), mdrt.values = "meansd", title = "")  + geom_line() + theme(legend.position="bottom") + ylab("Probabilidad Predicha") +  scale_x_continuous(breaks = c(1,2,3,4,5), labels=c("T. Satis.", 
                            "", 
                            "", 
                            "",
                            "T. Insatis.")) 
...
plot_it3<- plot_model(jv_carab2_2019.modelmulpub5, type = "pred", terms = c("ingreso[0:3000000]", "sj_obrero_rec"), mdrt.values = "meansd", title = "")  + geom_line() + theme(legend.position="bottom") + ylab("Probabilidad Predicha")
...
```{r}
ggpredict(jv_est_2019.modelmulpub4, "sj_ceo[0.13, 1.13, 2.13]")
```

```{r}
ggpredict(jv_carab1_2019.modelmulpub2, "sj_obrero_rec[0.25, 0.65, 1.05]")
```

```{r}
ggpredict(jv_carab2_2019.modelmulpub4, "sj_obrero_rec[0.25, 0.65, 1.05]")
```

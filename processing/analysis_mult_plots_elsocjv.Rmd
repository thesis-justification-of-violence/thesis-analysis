...
plot_pred_jvest <- plot_model(jv_est_2019.modelmulpub1, type = "pred", terms = c("sj_ceo_rec[all]"), title = "")  + geom_line() + theme(legend.position="bottom") + ylab("Probabilidad Predicha")
...
```{r}
ggpredict(jv_est_2019.modelmulpub4, "sj_ceo_rec[0.24, 1.16, 2.09]")
```
